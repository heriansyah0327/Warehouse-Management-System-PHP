...
$base = '../';
$active_menu = 'laporan';
$active_sub = 'lap_keluar';
$page_title = 'Laporan Barang Keluar - Gudang';
$page_header = 'Laporan Barang Keluar';
$page_icon = '&#128203;';
...
$sql = 'SELECT bk.id, bk.jumlah, bk.alasan, bk.tanggal, bk.diinput_oleh, k.jenis, k.nama_barang, k.class_senjata, k.tag_narko, k.tag_lainnya
        FROM barang_keluar bk
        JOIN kategori_barang k ON k.id = bk.id_barang';
if ($where) {
...
<div class="form-panel">
    ...
    <form method="GET" action="laporan_keluar.php" class="filter-row">
        ...
        <div class="form-group">
            <a href="laporan_keluar.php" class="btn-cancel-form" style="display:inline-flex;align-items:center;padding:10px 22px;">Reset</a>
        </div>
        <?php endif; ?>
    </form>
</div>
...
<div class="panel">
    ...
    <div class="panel-toolbar">
        ...
        <div class="search-box">
            <input type="text" placeholder="Cari ..." data-table-search="#laporanKeluarTable">
            <span class="icon">&#128269;</span>
        </div>
    </div>

    <table class="data-table" id="laporanKeluarTable">
        <thead>
            <tr>
                <th>No</th>
                <th>Tanggal</th>
        ...
        <tbody>
            <?php if (empty($rows)): ?>
                <tr><td colspan="8" style="text-align:center; color:var(--text-muted);">Belum ada data barang keluar.</td></tr>
            <?php else: ?>
    ...
    <div class="table-footer">
        <span>Total Baris: <?= count($rows) ?> | Total Jumlah Keluar: <?= $totalJumlah ?></span>
    </div>
</div>
